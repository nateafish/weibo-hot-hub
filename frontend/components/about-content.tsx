...
export function AboutContent() {
  ...
  return <div className="page"><PageHeader title="关于项目" subtitle="一个由 GitHub Actions 自动维护的微博热搜小时级、去重数据档案。" />
    <div className="about-grid"><Card className="about-card shadow-sm"><h2>保存了什么</h2><p>每小时保存微博热搜榜，并为可解析的话题关联数据总览、1 小时与 24 小时趋势、热搜记录、贡献者排行、搜索正文以及有变化的微博智搜结果。</p><h2 className="!mt-6">使用须知</h2><ul><li>公开页面仅用于研究与存档，不代表微博官方观点。</li><li>正文、用户名及链接来自公开页面，权利归原作者与微博所有。</li><li>部分话题可能没有热度、正文、趋势或智搜内容，页面会保留明确空状态。</li></ul></Card>
